    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="formBodyData">
          ...
          <input type="hidden" name="teacher_position_id" id="teacher_position_id">

          <div class="form-group">
            <label for="inputAddress">Teacher Position Name</label>
            <input type="text" class="form-control" id="teacher_position_name" name="teacher_position_name">
          </div>
